...
@Data
public class JdbApiRequestGetTokenDto extends JdbApiRequestParentDto{
    private BigDecimal balance;//  Double Y 余额
    ...
    private Integer jackpotFlag;//  Integer N 设定彩金开关    0: 打开（默认值）  1: 关闭
