...
//
//    // 长龙赔率缓存时间(分钟)
//    public static final long DRAGON_ODDS_CACHE_TIME = 10;
//
//    // ========================极光推送的标签================================================
...
//    public static final Integer LHC_BIGORSMALL_MEDIAN = 25;// 开奖号码计算大小,中间值
    ...
    //提出玩家
    public static final String DB_GAME_EXIT_USER = "17";
    //0 真人 1 试玩
...
//    // zf777支付
//    public static final String PAY_PLATFORM_ZF = "zf777";
//    //支付service 统一后缀
...
//    public static final String LOGIN_NUM_ANCHOR = "login_num_anchor_";
//    public static final String LOGIN_NUM_USER = "login_num_user_";
//    public static final String LOGIN_NUM_AGENT_PAY = "login_num_agent_pay_";
...
//    public static final String AREACODE_CHINA_MAINLAND_ADD86 = "+86";
//
//
//    /**
//     * 账号状态 1正常 9禁止登陆
...
//     * 彩种 icon 前缀key
//     */
//    public static final String LIVE_PHOTO_ICON_LOTTERY = "iconlottery/";
//    /**
//     * 头像 前缀key
//     */
...
//    // ord09用户取消 ord10已评价 ord11已退款 ord12已提现 ord13充值失败 ord14t提现失败 ord15t代付中 ord99已过期  ord98 有注单数据
...
//    // 申请状态 1提交申请 2提现处理中 3已经失败 4已打款 5家族长结算 6家族长打款 8已到账 9已取消
...
//    public static final Integer APYCSTATUS5 = 5;
//    public static final Integer APYCSTATUS6 = 6;
...
//    //    public static final int NUMBER_DECIMAL_POSITION = 3;
//    //机器人默认头像码
//    public static final String LIVE_HEADIMG = "HEADIMG";
//    //机器人
...
//
//    public static final Integer ZERO_TRAIL = 0;
//    public static final Integer NINE_TRAIL = 9;
//
//    public static final Integer ORDER_NORMAL = 0;
//    public static final Integer ORDER_TRAIL = 1;
//
//    public static final String TRIAL_MONEY = "1000";
//
//    public static final String THREE_PAY_CODE_WANTONG = "wantong";
//
//    public static final Integer LIVE_IS_MANAGER = 0;
//
//    public static final Integer LIVE_IS_NOT_MANAGER = 9;
//
//    public static final String ANCHOR_APP_INFO_UPDATE_APP = "/appInfo/updateApp";
//    public static final String ANCHOR_APP_INFO_APP_DOWNLOAD_URL = "/appInfo/appDownloadUrl";
//
//    //http签名访问默认最大错误次数
//    public static Integer HTTPSIGN_ERRCOUNT_DEFAULT = 10;
//    //腾讯流StopReason 停止原因  系统主动断开
//    public static String SYSTEM_UNPUBLISH_AUTO = "系统主动";
//
//    //默认配置腾讯AppName
//    public static final String LIVE = "live";
//    //24小时秒数
//    public static final Long REDIS_24_HOURE = 86400L; // 24 * 60 * 60l;
//    //1小时秒数
//    public static final Long REDIS_1_HOURE = 3600L; // 1 * 60 * 60l;
//    //10分钟秒数
//    public static final Long REDIS_10_MIN = 10 * 60L;
//    //开播记录合并最大间隔时间秒
//    public static final Long LIVE_ONLINE_INTERVAL = 10 * 60L;
//
//    /** 最大热门彩种数 */
//    public static final int LIVE_MAX_FAVORITE_LOTTERY_SIZE = 15;
//
//    /**
//     * 定时核查主播在线状态 最小确诊次数
//     */
//    public static final int LIVE_CHECK_STATUS_MIN = 1;
//
//    /**
//     * 主播定时监测状态记录有效期
//     */
//    public static final Long ANCHOR_LIVE_CHECK_TIME = 30 * 60l;
//
//    /**
//     * 在线活跃人数统计周期
//     */
//    public static final Integer ONLINE_ACTIVE_PEOPLE_STAT_INTERVAL = 5;
//
//    /**
//     * 在线活跃人数统计周期最小值
//     */
//    public static final Integer ONLINE_ACTIVE_PEOPLE_STAT_INTERVAL_MIN = 1;
//
//    /**
//     * 主播开播异常记录审查有效期（小时）
//     */
//    public static final Integer ONLINE_ERRCHECK_BEFORE_HOURE = 12;
//    /**
//     * 主播开播异常记录审查有效期（小时）
//     */
//    public static final Integer ONLINE_ERRCHECK_BEFORE_HOURE_24H = 24;
//
//    /**
//     * 直播间机器人没有配置时默认最小数量
//     */
//    public static final Integer LIVE_ROBOT_LEAST_NUMS = 15;
//
//    /**
//     * 直播间中奖机器人个数不达标时默认最小数量
//     */
//    public static final Integer LIVE_ROBOT_WINNING_LEAST_NUMS = 10;
//
//    /**
//     * 主播房间机器人上线数量
//     */
//    public static final Integer ANCHOR_ROOM_ROBOT_MAXIMUM = 60;
//
//    /**
//     * 用戶发言字数最大限制 默认值
//     */
//    public static final Integer ANCHOR_ROOMTALK_WORDS_MAX = 100;
//
//    /**
//     * 登录失败次数最大限制 默认值
//     */
//    public static final Integer ANCHOR_LOGIN_FAIL_NUM_MAX = 20;
//
//    /**
//     * 抢红包并发锁超时时间
//     */
//    public static final Integer RED_PACKET_LOCK_HOULDTIME = 1000 * 15;
//
//    /**
//     * 代付商 瑞联
//     */
//    public static final String PAY_FOR_RUILIAN = "ruilian";
//
//    /**
//     * 代付商 鑫
//     */
//    public static final String PAY_FOR_XIN = "xin";
//
//    /**
//     * 默认密码掩码
//     */
...
//
//    // 0 不是代付
//    public static final Integer ORDER_REPLACE_ZERO = 0;
//    // 1 是代付
//    public static final Integer ORDER_REPLACE_ONE = 1;
//
//    //创捷私钥
//    public static final String  CJ_PRVITE_KEY = "";
}
