...
public class AEUtil extends HttpCommonUtils {
    private static final Logger logger = LoggerFactory.getLogger(AEUtil.class);
    /**
     * 设置连接超时时间,单位毫秒
     */
     ...
     * @return
     */
    public static String doProxyPostJson(String proxyIp, int port, String tcp, String url, Map<String, String> paramsMap, String type, Integer userId, Map originParams) {
        // 设置代理IP、端口、协议
        // 创建HttpClientBuilder
