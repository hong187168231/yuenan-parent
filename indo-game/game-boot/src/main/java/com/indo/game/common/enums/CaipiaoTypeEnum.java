...
//    JSSSCFT("jssscft", "德州时时彩番摊", "2003"),
    ...
    public Integer getIntegerTagType() {
        return Integer.valueOf(this.getTagType());
    }
    ...
    public static String getlotteryName(Integer lotteryId) {
        ...
        String caipiaoid = String.valueOf(lotteryId);
        for (CaipiaoTypeEnum caipiaoTypeEnum : CaipiaoTypeEnum.values()) {
            if (caipiaoid.equals(caipiaoTypeEnum.getTagType())) {
                return caipiaoTypeEnum.getTagCnName();
            }
        }
        return null;
    }
