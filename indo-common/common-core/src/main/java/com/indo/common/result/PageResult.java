package com.indo.common.result;
...
public class PageResult<T> implements Serializable {
    ...
    private static <T> PageResult<T> result(IResultCode resultCode, T data) {
        return result(resultCode.getCode(), resultCode.getMsg(), data);
    }

    private static <T> PageResult<T> result(String code, String msg, T data) {
        PageResult<T> result = new PageResult<>();
        result.setCode(code);
        result.setData(data);
        result.setMsg(msg);
