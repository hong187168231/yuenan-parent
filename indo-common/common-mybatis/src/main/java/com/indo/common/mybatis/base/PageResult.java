package com.indo.common.mybatis.base;
...
public class PageResult<T> {
     ...
     * 从page获取分页总数
     */
    public static PageResult getPageResult(Pageable pageable, PageInfo<?> data) {
        Integer totalCount = null;
        if (null != data && data.getTotal() > 0) {
            totalCount = (int) data.getTotal();
        }
        PageResult pageResult = getPageResult(pageable.getPageNumber(), pageable.getPageSize(), totalCount);
        pageResult.setData(data.getList());
        return pageResult;
    }
     ...
     * 从page获取分页总数
     */
    public static PageResult getPageResult(Page<?> data) {
        Integer totalCount = null;
        if (null != data && data.getTotal() > 0) {
            totalCount = (int) data.getTotal();
        }
